...
router.get("/books", authentication, authorization, bookControllers.getFilteredBooks)
router.get("/books/:bookId", authentication, authorization, bookControllers.getBookById)
